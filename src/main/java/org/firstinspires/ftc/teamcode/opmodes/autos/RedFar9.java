...
@Autonomous(name = "Red Far 9", group = "Competition")
public class RedFar9 extends RobotOpMode {
    private Paths paths;
    ...
    private Command aimForPose(Pose pose) {
        Pose newPose = pose.withHeading(pose.getHeading() + Math.toRadians(1));
        return instant(() -> {
