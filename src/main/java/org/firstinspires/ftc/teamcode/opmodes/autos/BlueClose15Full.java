...
@Autonomous(name = "Blue Close 15 Full", group = "Competition")
public class BlueClose15Full extends RobotOpMode {
    private Paths paths;
    ...
    public void start() {
        ...
        schedule(
                sequential(
                        ...
                        robot.intake.off(),
                        instant(() -> robot.flywheel.setTarget(1355)),
